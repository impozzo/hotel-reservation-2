...
///////////////////////////// Guests Methods
	...
	public void addGuestChoice(Guests newGuest) {
		...
		// System.out.print("Has the guest stayed at the hotel before? If so, how many
		// times: ");
		// addGuest.setEmail(this.keyboardInput.nextLine());
	...
	public void editGuest() {
		...
		if (choice == 1) {
			...
			// send confirmation that the info has been changed and print new updated guest
			// info
		} else {
...
///////////////////////////// Reservations Methods
	...
	public int chooseReservationOption() {
		...
		String[] optionArray = new String[] { "Add Reservation", "Edit Reservation", "Delete Reservation",
				"Search Reservation" };
	...
	private void addReservationView() {
		...
		Reservations addReservation = new Reservations();
		String bookingDate;
		int bookingLength;
		int inputChoice;
		String roomType = "*";
		...
		bookingDate = this.keyboardInput.nextLine();

		System.out.print("How long:\n\n");
		System.out.print("?");

		bookingLength = Integer.parseInt(this.keyboardInput.nextLine());

		String[] optionArray = new String[] { "Single", "Double", "Triple", "Quad", "Suite", "Accessible",
				"Penthouse" };
		...
		inputChoice = Integer.parseInt(this.keyboardInput.nextLine());
		...
		// call addReservation
		Reservations passReservation = new Reservations();
		if(passReservation.addReservation(bookingDate, roomType , bookingLength))
		{
